...
const createGalleryItem = ({ url, alt }) =>
  `<li><img src="${url}" alt="${alt}" width = 500 height = 400></li>`;
...
galleryList.setAttribute("style", "list-style-type:none; display: flex; flex-direction: row; justify-content: space-between;");